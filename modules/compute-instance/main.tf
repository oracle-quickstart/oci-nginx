...
resource "oci_core_instance" "this" {
  ...
  create_vnic_details {
    assign_public_ip       = "${lookup(data.oci_core_subnets.this.subnets[count.index % length(data.oci_core_subnets.this.subnets)], "prohibit_public_ip_on_vnic") ? false : true && var.assign_public_ip}"
